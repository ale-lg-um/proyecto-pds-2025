...
public class Checklist extends ContenidoTarjeta {
	...
	/**
	 * Un checklist se considera completo si todos sus ítems están completados Esto
	 * es lógica interna del contenido, NO de la tarjeta
	 */
	...
	public String toString() {
		String itemsStr = items.stream().map(ItemChecklist::toString).reduce((a, b) -> a + ", " + b).orElse("-");

		return "Checklist: [" + itemsStr + "]";
	}
}